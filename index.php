                        ...
                        <div class="card-box">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover m-0 table-actions-bar">
                                    ...
                                    <tr>
                                        <td>
                                            <img src="Admin/Bootstrap_4_alpha6-Versions/default/assets/images/users/avatar-5.jpg" alt="contact-img" title="contact-img" class="rounded-circle thumb-sm" />
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <img src="Admin/Bootstrap_4_alpha6-Versions/default/assets/images/users/avatar-8.jpg" alt="contact-img" title="contact-img" class="rounded-circle thumb-sm" />
                                        </td>
